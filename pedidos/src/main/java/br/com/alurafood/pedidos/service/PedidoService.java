...
import br.com.alurafood.pedidos.http.PagamentoClientHttp;
...
public class PedidoService {
    ...
    @Autowired
    private PagamentoClientHttp pagamento;
    ...
    public PedidoDto obterPorIdEPagamento(Long id) {
        Pedido pedido = repository.findById(id)
                .orElseThrow(EntityNotFoundException::new);

//        pagamento.consultaPedido(id);
